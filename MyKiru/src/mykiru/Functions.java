...
public String[] full_Client(String IPA){
        try {
            URL game = new URL(IPA + "/UOAU/fullclient.php?fullurl");
            ...
            try (BufferedReader in = new BufferedReader(new
                ...
                String[] data1 = data.split("SS1337SS");
                //String FileSize = data1[0];
                //String File = data1[1];
                return data1;
            }
        } catch (Exception e) {}
...
public String find_message(String find, String from, String replace, String replace_with){
    String[] one;
    if(from.contains("<"+find.toLowerCase()+">") == false || from.contains("</"+find.toLowerCase()+">") == false){return "";}
    try{
    one = from.split("<"+find.toLowerCase()+">");
    one = one[1].split("</"+find.toLowerCase()+">");
